...
router.post('/edit_record', function (req, res, next) {
    try {
        ...
        // console.log(error)
        pool.query(
            'update deliveryboy set branchid=?,deliveryname=?,dob=?,gender=?,mobileno=?,state=?,city=?,aadharno=?,status=?,vehicleno=?,photograph=?,password=?,emailid=?,address=?,createdate=?,createtime=? where  deliveryid=?', [req.body.branchid, req.body.deliveryname, req.body.dob, req.body.gender, req.body.mobileno, req.body.state, req.body.city, req.body.aadharno, req.body.status, req.body.vehicleno, req.body.photograph, req.body.password, req.body.emailid, req.body.address, req.body.createdate, req.body.createtime,req.body.deliveryid],
            function (error, result) {
                if (error) {
